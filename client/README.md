...
- The long‑term goal is compatibility with other versions as well (v1.188 is only a plugin).
...
```
cd existing_repo
git remote add origin https://gitlab.com/sro-pserver-network/sro-rs-client.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/sro-pserver-network/sro-rs-client/-/settings/integrations)
